...
<head>
    ...
    @vite(['resources/assets/js/user/chocotissue/user-ranking.js', 'resources/assets/sass/user/chocotissue/index.scss'])
</head>
<body>
<div>
    <div style="display: inline-flex;flex-direction: row;align-items: flex-start;flex-wrap: wrap;position: relative; margin: 0 0 50px;" data-target="tissues">
        @include('user.chocotissue.common.user-ranking-tissues')
    </div>
</div>
